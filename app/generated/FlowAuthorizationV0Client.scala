 ...
 * apidoc:0.10.1 http://localhost:9000/flow/authorization/0.0.5-dev/play_2_4_client
 */
...
package io.flow.authorization.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.10.1 http://localhost:9000/flow/authorization/0.0.5-dev/play_2_4_client"
