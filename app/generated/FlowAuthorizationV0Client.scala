 ...
 * apidoc:0.9.45 http://localhost:9000/flow/authorization/0.0.1-dev/play_2_4_client
 */
...
package io.flow.authorization.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.9.45 http://localhost:9000/flow/authorization/0.0.1-dev/play_2_4_client"
