 ...
 * apidoc:0.11.11 http://www.apidoc.me/flow/authorization/0.0.9/play_2_4_client
 */
package io.flow.authorization.v0.models {

  sealed trait Authorization

  sealed trait AuthorizationSummary
  ...
  case class AuthorizationRoleSummary(
    id: String,
    privilege: io.flow.authorization.v0.models.Privilege,
    context: String,
    role: io.flow.authorization.v0.models.RoleReference
  ) extends AuthorizationSummary
  ...
  case class AuthorizationUserSummary(
    id: String,
    privilege: io.flow.authorization.v0.models.Privilege,
    context: String,
  ...
  case class AuthorizationVersion(
    ...
    authorization: io.flow.authorization.v0.models.AuthorizationSummary
  )
  ...
  /**
   * Provides future compatibility in clients - in the future, when a type is added
   * to the union AuthorizationSummary, it will need to be handled in the client
   * code. This implementation will deserialize these future types as an instance of
   * this class.
   */
  case class AuthorizationSummaryUndefinedType(
    description: String
  ) extends AuthorizationSummary
...
package io.flow.authorization.v0.models {
  ...
  package object json {
    ...
    def jsonWritesAuthorizationPrivilege(obj: io.flow.authorization.v0.models.Privilege) = {
    ...
    implicit def jsonWritesAuthorizationPrivilege: play.api.libs.json.Writes[Privilege] = {
      new play.api.libs.json.Writes[io.flow.authorization.v0.models.Privilege] {
        def writes(obj: io.flow.authorization.v0.models.Privilege) = {
          jsonWritesAuthorizationPrivilege(obj)
        }
      }
    }
    ...
    implicit def jsonReadsAuthorizationAuthorizationRoleSummary: play.api.libs.json.Reads[AuthorizationRoleSummary] = {
      (
        (__ \ "id").read[String] and
        (__ \ "privilege").read[io.flow.authorization.v0.models.Privilege] and
        (__ \ "context").read[String] and
        (__ \ "role").read[io.flow.authorization.v0.models.RoleReference]
      )(AuthorizationRoleSummary.apply _)
    }

    def jsObjectAuthorizationRoleSummary(obj: io.flow.authorization.v0.models.AuthorizationRoleSummary) = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id),
        "privilege" -> play.api.libs.json.JsString(obj.privilege.toString),
        "context" -> play.api.libs.json.JsString(obj.context),
        "role" -> jsObjectRoleReference(obj.role)
      )
    }
    ...
    implicit def jsonReadsAuthorizationAuthorizationUserSummary: play.api.libs.json.Reads[AuthorizationUserSummary] = {
      (
        (__ \ "id").read[String] and
        (__ \ "privilege").read[io.flow.authorization.v0.models.Privilege] and
        (__ \ "context").read[String] and
        (__ \ "user").read[io.flow.common.v0.models.UserReference]
      )(AuthorizationUserSummary.apply _)
    }

    def jsObjectAuthorizationUserSummary(obj: io.flow.authorization.v0.models.AuthorizationUserSummary) = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id),
        "privilege" -> play.api.libs.json.JsString(obj.privilege.toString),
        "context" -> play.api.libs.json.JsString(obj.context),
    ...
    implicit def jsonReadsAuthorizationAuthorizationVersion: play.api.libs.json.Reads[AuthorizationVersion] = {
      (
        ...
        (__ \ "authorization").read[io.flow.authorization.v0.models.AuthorizationSummary]
    ...
    def jsObjectAuthorizationVersion(obj: io.flow.authorization.v0.models.AuthorizationVersion) = {
      play.api.libs.json.Json.obj(
        ...
        "authorization" -> jsObjectAuthorizationSummary(obj.authorization)
      )
    }
    ...
    implicit def jsonReadsAuthorizationRoleReference: play.api.libs.json.Reads[RoleReference] = {
      (__ \ "id").read[String].map { x => new RoleReference(id = x) }
    }

    def jsObjectRoleReference(obj: io.flow.authorization.v0.models.RoleReference) = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id)
      )
    }

    implicit def jsonWritesAuthorizationRoleReference: play.api.libs.json.Writes[RoleReference] = {
      new play.api.libs.json.Writes[io.flow.authorization.v0.models.RoleReference] {
        def writes(obj: io.flow.authorization.v0.models.RoleReference) = {
          jsObjectRoleReference(obj)
        }
      }
    }
    ...
    implicit def jsonReadsAuthorizationAuthorizationSummary: play.api.libs.json.Reads[AuthorizationSummary] = new play.api.libs.json.Reads[AuthorizationSummary] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[AuthorizationSummary] = {
        (js \ "discriminator").validate[String] match {
          case play.api.libs.json.JsError(msg) => play.api.libs.json.JsError(msg)
          case play.api.libs.json.JsSuccess(discriminator, _) => {
            discriminator match {
              case "authorization_role_summary" => js.validate[io.flow.authorization.v0.models.AuthorizationRoleSummary]
              case "authorization_user_summary" => js.validate[io.flow.authorization.v0.models.AuthorizationUserSummary]
              case other => play.api.libs.json.JsSuccess(io.flow.authorization.v0.models.AuthorizationSummaryUndefinedType(other))
            }
          }
        }
      }
    ...
    def jsObjectAuthorizationSummary(obj: io.flow.authorization.v0.models.AuthorizationSummary) = {
      obj match {
        case x: io.flow.authorization.v0.models.AuthorizationRoleSummary => jsObjectAuthorizationRoleSummary(x) ++ play.api.libs.json.Json.obj("discriminator" -> "authorization_role_summary")
        case x: io.flow.authorization.v0.models.AuthorizationUserSummary => jsObjectAuthorizationUserSummary(x) ++ play.api.libs.json.Json.obj("discriminator" -> "authorization_user_summary")
        case other => {
          sys.error(s"The type[${other.getClass.getName}] has no JSON writer")
        }
      }
    ...
    implicit def jsonWritesAuthorizationAuthorizationSummary: play.api.libs.json.Writes[AuthorizationSummary] = {
      new play.api.libs.json.Writes[io.flow.authorization.v0.models.AuthorizationSummary] {
        def writes(obj: io.flow.authorization.v0.models.AuthorizationSummary) = {
          jsObjectAuthorizationSummary(obj)
        }
      }
    }
  }
...
package io.flow.authorization.v0 {
  ...
  object Constants {
    ...
    val Namespace = "io.flow.authorization.v0"
    val UserAgent = "apidoc:0.11.11 http://www.apidoc.me/flow/authorization/0.0.9/play_2_4_client"
    val Version = "0.0.9"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object Authorizations extends Authorizations {
      ...
      override def getVersions(
        id: _root_.scala.Option[Seq[String]] = None,
        authorizationId: _root_.scala.Option[Seq[String]] = None,
        limit: Long = 25,
        offset: Long = 0,
        ...
        val queryParameters = Seq(
          ...
          id.getOrElse(Nil).map("id" -> _) ++
          authorizationId.getOrElse(Nil).map("authorization_id" -> _)
  ...
  package interfaces {
    ...
    trait Client {
      def authorizations: io.flow.authorization.v0.Authorizations
      def checks: io.flow.authorization.v0.Checks
      def healthchecks: io.flow.authorization.v0.Healthchecks
      def memberships: io.flow.authorization.v0.Memberships
      def roles: io.flow.authorization.v0.Roles
    }
