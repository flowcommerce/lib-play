 ...
 * apibuilder 0.14.59 app.apibuilder.io/flow/common/0.7.30/play_2_6_client
 */
...
package io.flow.common.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsCommonDatetimeRange: play.api.libs.json.Reads[DatetimeRange] = {
      for {
        from <- (__ \ "from").read[_root_.java.time.Instant]
        to <- (__ \ "to").read[_root_.java.time.Instant]
    ...
    def jsObjectDatetimeRange(obj: io.flow.common.v0.models.DatetimeRange): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "from" -> play.api.libs.json.JsString(obj.from.toString),
        "to" -> play.api.libs.json.JsString(obj.to.toString)
      )
    }
    ...
    implicit def jsonReadsCommonOrganization: play.api.libs.json.Reads[Organization] = {
      for {
        ...
        createdAt <- (__ \ "created_at").readNullable[_root_.java.time.Instant]
    ...
    def jsObjectOrganization(obj: io.flow.common.v0.models.Organization): play.api.libs.json.JsObject = {
      ...
      (obj.createdAt match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("created_at" -> play.api.libs.json.JsString(x.toString))
      })
    }
...
package io.flow.common.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.59 app.apibuilder.io/flow/common/0.7.30/play_2_6_client"
    val Version = "0.7.30"
    val VersionMajor = 0
