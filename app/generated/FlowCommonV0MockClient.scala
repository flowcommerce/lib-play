 ...
 * apibuilder 0.14.3 app.apibuilder.io/flow/common/0.5.69/play_2_6_mock_client
 */
package io.flow.common.v0.mock {
  ...
  object Factories {
    ...
    def makeMerchantOfRecordEntity(): io.flow.common.v0.models.MerchantOfRecordEntity = io.flow.common.v0.models.MerchantOfRecordEntity(
      name = Factories.randomString(),
      vat = io.flow.common.v0.mock.Factories.makeVatRegistration(),
      streets = Nil,
    ...
    def makeVatRegistration(): io.flow.common.v0.models.VatRegistration = io.flow.common.v0.models.VatRegistration(
      number = Factories.randomString(),
      country = Factories.randomString()
    )
