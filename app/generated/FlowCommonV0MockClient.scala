 ...
 * apibuilder 0.14.75 app.apibuilder.io/flow/common/0.7.53/play_2_6_mock_client
 */
package io.flow.common.v0.mock {
  ...
  object Factories {
    ...
    def makeCustomerForm(): io.flow.common.v0.models.CustomerForm = io.flow.common.v0.models.CustomerForm(
      name = None,
      number = None,
      phone = None,
      email = None,
