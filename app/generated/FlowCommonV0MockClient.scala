 ...
 * apidoc:0.11.33 http://www.apidoc.me/flow/common/0.0.73/play_2_4_mock_client
 */
package io.flow.common.v0.mock {
  ...
  object Factories {
    ...
    def makeItemSummary() = io.flow.common.v0.models.ItemSummary(
      number = randomString(),
      quantity = 1l
    )

    def makeMargin() = io.flow.common.v0.models.Margin(
      name = io.flow.common.v0.mock.Factories.makeMarginType(),
      value = BigDecimal("1")
    )
    ...
    def makeRounding() = io.flow.common.v0.models.Rounding(
      name = io.flow.common.v0.mock.Factories.makeRoundingType(),
