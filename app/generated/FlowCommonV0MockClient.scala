 ...
 * User agent: apibuilder app.apibuilder.io/flow/common/latest/play_2_8_mock_client
 */
package io.flow.common.v0.mock {
  ...
  object Factories {
    ...
    def makeOrganizationType(): io.flow.common.v0.models.OrganizationType = io.flow.common.v0.models.OrganizationType.Standalone
    ...
    def makeChannelReference(): io.flow.common.v0.models.ChannelReference = io.flow.common.v0.models.ChannelReference(
      id = Factories.randomString(24)
    )
    ...
    def makeLogoImageSetStatic(): io.flow.common.v0.models.LogoImageSetStatic = io.flow.common.v0.models.LogoImageSetStatic(
      small = None,
      medium = io.flow.common.v0.mock.Factories.makeLogoImageStatic(),
      large = None
    )

    def makeLogoImageStatic(): io.flow.common.v0.models.LogoImageStatic = io.flow.common.v0.models.LogoImageStatic(
      url = Factories.randomString(24),
      width = 1,
      height = 1
    )

    def makeLogoImageSvg(): io.flow.common.v0.models.LogoImageSvg = io.flow.common.v0.models.LogoImageSvg(
      url = Factories.randomString(24)
    )
    ...
    def makeLogoImage(): io.flow.common.v0.models.LogoImage = io.flow.common.v0.mock.Factories.makeLogoImageSvg()
