 ...
 * apidoc:0.11.92 http://www.apidoc.me/flow/healthcheck/0.3.36/play_2_4_client
 */
...
package io.flow.healthcheck.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.92 http://www.apidoc.me/flow/healthcheck/0.3.36/play_2_4_client"
    val Version = "0.3.36"
    val VersionMajor = 0
    ...
    object Healthchecks extends Healthchecks {
      override def getHealthcheck(
        ...
        _executeRequest("GET", s"/_internal_/healthcheck", requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 422 => throw new io.flow.healthcheck.v0.errors.GenericErrorResponse(r)
    ...
    def parseJson[T](
      ...
      f(play.api.libs.json.Json.parse(r.body)) match {
        ...
        case play.api.libs.json.JsError(errors) => {
          throw new io.flow.healthcheck.v0.errors.FailedRequest(r.status, s"Invalid json for class[" + className + "]: " + errors.mkString(" "))
        }
      }
    }
