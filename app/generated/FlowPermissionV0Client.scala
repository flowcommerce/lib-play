...
package io.flow.permission.v0.models {
  ...
  object FlowRole {
     ...
     * above.
     */
    val all: scala.List[FlowRole] = scala.List(OrganizationAdmin, OrganizationMerchant, OrganizationCustomerService, OrganizationFulfillment, OrganizationMarketing, OrganizationFinance, FlowOperations, ChannelAdmin, ChannelOrganizationAdmin)
