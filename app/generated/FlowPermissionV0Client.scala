 ...
 * apibuilder 0.14.93 app.apibuilder.io/flow/permission/latest/play_2_8_client
 */
package io.flow.permission.v0.models {
  ...
  /**
   * Defines the valid discriminator values for the type FlowRole
   */
  sealed trait FlowRoleDiscriminator extends _root_.scala.Product with _root_.scala.Serializable

  object FlowRoleDiscriminator {

    case object FlowUserRole extends FlowRoleDiscriminator { override def toString = "flow_user_role" }
    case object FlowAddonRole extends FlowRoleDiscriminator { override def toString = "flow_addon_role" }

    final case class UNDEFINED(override val toString: String) extends FlowRoleDiscriminator

    val all: scala.List[FlowRoleDiscriminator] = scala.List(FlowUserRole, FlowAddonRole)

    private[this] val byName: Map[String, FlowRoleDiscriminator] = all.map(x => x.toString.toLowerCase -> x).toMap

    def apply(value: String): FlowRoleDiscriminator = fromString(value).getOrElse(UNDEFINED(value))

    def fromString(value: String): _root_.scala.Option[FlowRoleDiscriminator] = byName.get(value.toLowerCase)
...
package io.flow.permission.v0.models {
  ...
  package object json {
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "flow_addon_role").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.permission.v0.models.FlowAddonRole(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
    ...
    def jsObjectFlowAddonRole(obj: io.flow.permission.v0.models.FlowAddonRole) = {
      play.api.libs.json.Json.obj("discriminator" -> "flow_addon_role", "value" -> play.api.libs.json.JsString(obj.toString))
    }
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "flow_user_role").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.permission.v0.models.FlowUserRole(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
    ...
    def jsObjectFlowUserRole(obj: io.flow.permission.v0.models.FlowUserRole) = {
      play.api.libs.json.Json.obj("discriminator" -> "flow_user_role", "value" -> play.api.libs.json.JsString(obj.toString))
    }
    ...
    def jsObjectFlowRole(obj: io.flow.permission.v0.models.FlowRole): play.api.libs.json.JsObject = {
      obj match {
        case x: io.flow.permission.v0.models.FlowUserRole => jsObjectFlowUserRole(x)
        case x: io.flow.permission.v0.models.FlowAddonRole => jsObjectFlowAddonRole(x)
        case other => {
...
package io.flow.permission.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.93 app.apibuilder.io/flow/permission/latest/play_2_8_client"
    val Version = "0.8.75"
    val VersionMajor = 0
