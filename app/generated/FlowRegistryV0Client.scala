 ...
 * apidoc:0.11.37 http://www.apidoc.me/flow/registry/0.1.30/ning_1_9_client
 */
...
package io.flow.registry.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.37 http://www.apidoc.me/flow/registry/0.1.30/ning_1_9_client"
    val Version = "0.1.30"
    val VersionMajor = 0
    ...
    object Applications extends Applications {
      ...
      override def post(
        ...
        _executeRequest("POST", s"/applications", body = Some(payload), requestHeaders = requestHeaders).map {
          ...
          case r if r.getStatusCode == 401 => throw new io.flow.registry.v0.errors.UnitResponse(r.getStatusCode)
          case r if r.getStatusCode == 422 => throw new io.flow.registry.v0.errors.ValidationErrorsResponse(r)
