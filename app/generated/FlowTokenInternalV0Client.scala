 ...
 * Service version: 0.26.69
 * User agent: apibuilder app.apibuilder.io/flow/token-internal/latest/play_2_8_client
 */
...
package io.flow.token.internal.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder app.apibuilder.io/flow/token-internal/latest/play_2_8_client"
    val Version = "0.26.69"
    val VersionMajor = 0
  ...
  class Client(
    ...
    private val logger = play.api.Logger("io.flow.token.internal.v0.Client")
