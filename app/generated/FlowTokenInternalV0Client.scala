 ...
 * apibuilder 0.15.33 app.apibuilder.io/flow/token-internal/latest/play_2_8_client
 */
package io.flow.token.internal.v0.models {
...
package io.flow.token.internal.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsTokenInternalChannelTokenForm: play.api.libs.json.Reads[ChannelTokenForm] = {
      for {
    ...
    def jsObjectChannelTokenForm(obj: io.flow.token.internal.v0.models.ChannelTokenForm): play.api.libs.json.JsObject = {
    ...
    implicit def jsonWritesTokenInternalChannelTokenForm: play.api.libs.json.Writes[ChannelTokenForm] = {
      (obj: io.flow.token.internal.v0.models.ChannelTokenForm) => {
...
package io.flow.token.internal.v0 {
...
package io.flow.token.internal.v0 {
  ...
  object Constants {
    ...
    val Namespace = "io.flow.token.internal.v0"
    val UserAgent = "apibuilder 0.15.33 app.apibuilder.io/flow/token-internal/latest/play_2_8_client"
    val Version = "0.14.63"
    val VersionMajor = 0
  ...
  class Client(
    ...
    auth: scala.Option[io.flow.token.internal.v0.Authorization] = None,
    ...
    private[this] val logger = play.api.Logger("io.flow.token.internal.v0.Client")

    logger.info(s"Initializing io.flow.token.internal.v0.Client for url $baseUrl")
    ...
    object ChannelTokens extends ChannelTokens {
      override def post(
        ...
        _executeRequest("POST", s"/internal/channel/tokens", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.status == 201 => _root_.io.flow.token.internal.v0.Client.parseJson("io.flow.token.v0.models.ChannelToken", r, _.validate[io.flow.token.v0.models.ChannelToken])
          case r if r.status == 401 => throw io.flow.token.internal.v0.errors.UnitResponse(r.status)
          case r if r.status == 403 => throw io.flow.token.internal.v0.errors.PermissionErrorResponse(r)
          case r if r.status == 422 => throw io.flow.token.internal.v0.errors.GenericErrorResponse(r)
          case r => throw io.flow.token.internal.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 201, 401, 403, 422")
        }
      }
    }
    ...
    def parseJson[T](
      ...
      f(play.api.libs.json.Json.parse(r.body)) match {
        ...
        case play.api.libs.json.JsError(errors) => {
          throw io.flow.token.internal.v0.errors.FailedRequest(r.status, s"Invalid json for class[" + className + "]: " + errors.mkString(" "))
        }
      }
    }
  ...
  package interfaces {
    ...
    trait Client {
      def baseUrl: String
      def channelTokens: io.flow.token.internal.v0.ChannelTokens
    }
  ...
  package errors {
    ...
    final case class GenericErrorResponse(
      ...
      lazy val genericError = _root_.io.flow.token.internal.v0.Client.parseJson("io.flow.error.v0.models.GenericError", response, _.validate[io.flow.error.v0.models.GenericError])
    }
    ...
    final case class PermissionErrorResponse(
      ...
      lazy val permissionError = _root_.io.flow.token.internal.v0.Client.parseJson("io.flow.permission.v0.models.PermissionError", response, _.validate[io.flow.permission.v0.models.PermissionError])
    }
