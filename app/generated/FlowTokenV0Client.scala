  ...
  package object json {
    ...
    implicit def jsonReadsTokenChannelToken: play.api.libs.json.Reads[ChannelToken] = {
      for {
        ...
        channel <- (__ \ "channel").read[String]
    ...
    def jsObjectChannelToken(obj: io.flow.token.v0.models.ChannelToken): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "channel" -> play.api.libs.json.JsString(obj.channel),
    ...
    implicit def jsonReadsTokenChannelTokenForm: play.api.libs.json.Reads[ChannelTokenForm] = {
      (__ \ "description").readNullable[String].map { x => new ChannelTokenForm(description = x) }
    }
