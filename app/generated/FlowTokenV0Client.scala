 ...
 * apibuilder 0.14.3 app.apibuilder.io/flow/token/0.4.90/play_2_6_client
 */
...
package io.flow.token.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.3 app.apibuilder.io/flow/token/0.4.90/play_2_6_client"
    val Version = "0.4.90"
    val VersionMajor = 0
