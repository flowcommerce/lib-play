 ...
 * Service version: 0.16.4-ben
 * apibuilder 0.15.33 app.apibuilder.io/flow/token/0.16.4-ben/play_2_8_client
 */
...
package io.flow.token.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsTokenOrganizationTokenFormV2: play.api.libs.json.Reads[OrganizationTokenFormV2] = {
      for {
    ...
    implicit def jsonWritesTokenOrganizationTokenFormV2: play.api.libs.json.Writes[OrganizationTokenFormV2] = {
      (obj: io.flow.token.v0.models.OrganizationTokenFormV2) => {
        jsObjectOrganizationTokenFormV2(obj)
      }
    }
    ...
    implicit def jsonReadsTokenOrganizationTokenV2: play.api.libs.json.Reads[OrganizationTokenV2] = {
      for {
        id <- (__ \ "id").read[String]
        organization <- (__ \ "organization").read[io.flow.common.v0.models.OrganizationReference]
        user <- (__ \ "user").read[io.flow.common.v0.models.UserReference]
    ...
    implicit def jsonWritesTokenOrganizationTokenV2: play.api.libs.json.Writes[OrganizationTokenV2] = {
      (obj: io.flow.token.v0.models.OrganizationTokenV2) => {
        jsObjectOrganizationTokenV2(obj)
      }
    }

    implicit def jsonReadsTokenOrganizationTokenV2Reference: play.api.libs.json.Reads[OrganizationTokenV2Reference] = {
      for {
        id <- (__ \ "id").read[String]
        organization <- (__ \ "organization").read[io.flow.common.v0.models.OrganizationReference]
    ...
    implicit def jsonWritesTokenOrganizationTokenV2Reference: play.api.libs.json.Writes[OrganizationTokenV2Reference] = {
      (obj: io.flow.token.v0.models.OrganizationTokenV2Reference) => {
        jsObjectOrganizationTokenV2Reference(obj)
      }
    }
    ...
    implicit def jsonReadsTokenTokenRbacAuthenticationForm: play.api.libs.json.Reads[TokenRbacAuthenticationForm] = {
      for {
    ...
    implicit def jsonWritesTokenTokenRbacAuthenticationForm: play.api.libs.json.Writes[TokenRbacAuthenticationForm] = {
      (obj: io.flow.token.v0.models.TokenRbacAuthenticationForm) => {
        jsObjectTokenRbacAuthenticationForm(obj)
      }
    }
    ...
    implicit def jsonReadsTokenToken: play.api.libs.json.Reads[Token] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
          ...
          case "organization_token_v2" => js.validate[io.flow.token.v0.models.OrganizationTokenV2]
    ...
    def jsObjectToken(obj: io.flow.token.v0.models.Token): play.api.libs.json.JsObject = {
      obj match {
        ...
        case x: io.flow.token.v0.models.OrganizationTokenV2 => jsObjectOrganizationTokenV2(x)
    ...
    implicit def jsonReadsTokenTokenReference: play.api.libs.json.Reads[TokenReference] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
          ...
          case "organization_token_v2_reference" => js.validate[io.flow.token.v0.models.OrganizationTokenV2Reference]
    ...
    def jsObjectTokenReference(obj: io.flow.token.v0.models.TokenReference): play.api.libs.json.JsObject = {
      obj match {
        ...
        case x: io.flow.token.v0.models.OrganizationTokenV2Reference => jsObjectOrganizationTokenV2Reference(x)
...
package io.flow.token.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.15.33 app.apibuilder.io/flow/token/0.16.4-ben/play_2_8_client"
    val Version = "0.16.4-ben"
    val VersionMajor = 0
