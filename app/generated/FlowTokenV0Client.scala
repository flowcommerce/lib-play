 ...
 * apibuilder 0.15.33 app.apibuilder.io/flow/token/0.0.1-dev/play_2_8_client
 */
package io.flow.token.v0.models {
  ...
  final case class ChannelToken(
    id: String,
    channel: io.flow.token.v0.models.TokenChannelReference,
  ...
  final case class TokenChannelReference(
    id: String
  )
  ...
  package object json {
    ...
    implicit def jsonReadsTokenChannelToken: play.api.libs.json.Reads[ChannelToken] = {
      for {
        ...
        channel <- (__ \ "channel").read[io.flow.token.v0.models.TokenChannelReference]
    ...
    def jsObjectChannelToken(obj: io.flow.token.v0.models.ChannelToken): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "channel" -> jsObjectTokenChannelReference(obj.channel),
    ...
    implicit def jsonWritesTokenChannelToken: play.api.libs.json.Writes[ChannelToken] = {
      new play.api.libs.json.Writes[io.flow.token.v0.models.ChannelToken] {
        def writes(obj: io.flow.token.v0.models.ChannelToken) = {
    ...
    implicit def jsonWritesTokenChannelTokenReference: play.api.libs.json.Writes[ChannelTokenReference] = {
      new play.api.libs.json.Writes[io.flow.token.v0.models.ChannelTokenReference] {
        def writes(obj: io.flow.token.v0.models.ChannelTokenReference) = {
    ...
    implicit def jsonReadsTokenTokenChannelReference: play.api.libs.json.Reads[TokenChannelReference] = {
      (__ \ "id").read[String].map { x => new TokenChannelReference(id = x) }
    }

    def jsObjectTokenChannelReference(obj: io.flow.token.v0.models.TokenChannelReference): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id)
      )
    }

    implicit def jsonWritesTokenTokenChannelReference: play.api.libs.json.Writes[TokenChannelReference] = {
      new play.api.libs.json.Writes[io.flow.token.v0.models.TokenChannelReference] {
        def writes(obj: io.flow.token.v0.models.TokenChannelReference) = {
          jsObjectTokenChannelReference(obj)
        }
      }
    }
...
package io.flow.token.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.15.33 app.apibuilder.io/flow/token/0.0.1-dev/play_2_8_client"
