 ...
 * apibuilder 0.14.59 app.apibuilder.io/flow/token/0.7.22/play_2_6_client
 */
  ...
  package object json {
    ...
    implicit def jsonReadsTokenOrganizationToken: play.api.libs.json.Reads[OrganizationToken] = {
      for {
        ...
        createdAt <- (__ \ "created_at").read[_root_.java.time.Instant]
    ...
    def jsObjectOrganizationToken(obj: io.flow.token.v0.models.OrganizationToken): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "created_at" -> play.api.libs.json.JsString(obj.createdAt.toString)
...
package io.flow.token.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.59 app.apibuilder.io/flow/token/0.7.22/play_2_6_client"
    val Version = "0.7.22"
    val VersionMajor = 0
