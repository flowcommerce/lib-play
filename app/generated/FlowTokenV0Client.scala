 ...
 * apibuilder:0.12.3 https://api.apibuilder.io/flow/token/0.3.36/play_2_4_client
 */
...
package io.flow.token.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.3 https://api.apibuilder.io/flow/token/0.3.36/play_2_4_client"
    val Version = "0.3.36"
    val VersionMajor = 0
