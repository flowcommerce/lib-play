 ...
 * apibuilder 0.14.93 app.apibuilder.io/flow/token/latest/play_2_8_client
 */
...
package io.flow.token.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.93 app.apibuilder.io/flow/token/latest/play_2_8_client"
    val Version = "0.7.58"
    val VersionMajor = 0
