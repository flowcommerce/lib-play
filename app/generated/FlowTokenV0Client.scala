 ...
 * apibuilder 0.15.6 app.apibuilder.io/flow/token/latest/play_2_8_client
 */
...
package io.flow.token.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.15.6 app.apibuilder.io/flow/token/latest/play_2_8_client"
    val Version = "0.9.10"
    val VersionMajor = 0
