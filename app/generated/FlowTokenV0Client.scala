 ...
 * apidoc:0.11.17 http://www.apidoc.me/flow/token/0.0.1/play_2_4_client
 */
...
package io.flow.token.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.17 http://www.apidoc.me/flow/token/0.0.1/play_2_4_client"
    val Version = "0.0.1"
    val VersionMajor = 0
    ...
    object Tokens extends Tokens {
      ...
      override def getByToken(
        ...
        _executeRequest("GET", s"/tokens/${play.utils.UriEncoding.encodePathSegment(token, "UTF-8")}").map {
          ...
          case r if r.status == 404 => throw new io.flow.token.v0.errors.TokenResponse(r)
  ...
  package errors {
    ...
    case class TokenResponse(
      ...
      lazy val token = _root_.io.flow.token.v0.Client.parseJson("io.flow.token.v0.models.Token", response, _.validate[io.flow.token.v0.models.Token])
    }
