 ...
 * apidoc:0.11.75 http://www.apidoc.me/flow/token/0.2.50/play_2_4_client
 */
package io.flow.token.v0.models {
   ...
   */
  sealed trait TokenDiscriminator
   ...
   */
  sealed trait TokenFormDiscriminator
   ...
   */
  sealed trait TokenReferenceDiscriminator
...
package io.flow.token.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.75 http://www.apidoc.me/flow/token/0.2.50/play_2_4_client"
    val Version = "0.2.50"
    val VersionMajor = 0
