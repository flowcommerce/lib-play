 ...
 * apibuilder 0.15.33 app.apibuilder.io/flow/token/0.0.1-dev/play_2_8_mock_client
 */
package io.flow.token.v0.mock {
  ...
  object Factories {
    ...
    def makeChannelToken(): io.flow.token.v0.models.ChannelToken = io.flow.token.v0.models.ChannelToken(
      ...
      channel = io.flow.token.v0.mock.Factories.makeTokenChannelReference(),
    ...
    def makeTokenChannelReference(): io.flow.token.v0.models.TokenChannelReference = io.flow.token.v0.models.TokenChannelReference(
      id = Factories.randomString(24)
    )
