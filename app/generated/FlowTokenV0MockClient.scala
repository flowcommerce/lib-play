 ...
 * apidoc:0.11.49 http://www.apidoc.me/flow/token/0.2.2/play_2_4_mock_client
 */
package io.flow.token.v0.mock {
  ...
  trait MockTokens extends io.flow.token.v0.Tokens {
    ...
    def postAuthentications(
      ...
      requestHeaders: Seq[(String, String)] = Nil
    )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.flow.token.v0.models.LegacyTokenReference] = scala.concurrent.Future {
      io.flow.token.v0.mock.Factories.makeLegacyTokenReference()
    }
