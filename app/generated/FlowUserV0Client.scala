 ...
 * User agent: apibuilder app.apibuilder.io/flow/user/latest/play_2_8_client
 */
...
package io.flow.user.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsUserAuthenticationForm: play.api.libs.json.Reads[io.flow.user.v0.models.AuthenticationForm] = {
      for {
    ...
    implicit def jsonWritesUserAuthenticationForm: play.api.libs.json.Writes[AuthenticationForm] = {
      (obj: io.flow.user.v0.models.AuthenticationForm) => {
        io.flow.user.v0.models.json.jsObjectAuthenticationForm(obj)
      }
    }

    implicit def jsonReadsUserEmailVerification: play.api.libs.json.Reads[io.flow.user.v0.models.EmailVerification] = {
      (__ \ "email").read[String].map { x => EmailVerification(email = x) }
    }
    ...
    implicit def jsonWritesUserEmailVerification: play.api.libs.json.Writes[EmailVerification] = {
      (obj: io.flow.user.v0.models.EmailVerification) => {
        io.flow.user.v0.models.json.jsObjectEmailVerification(obj)
      }
    }

    implicit def jsonReadsUserNameForm: play.api.libs.json.Reads[io.flow.user.v0.models.NameForm] = {
      for {
    ...
    implicit def jsonWritesUserNameForm: play.api.libs.json.Writes[NameForm] = {
      (obj: io.flow.user.v0.models.NameForm) => {
        io.flow.user.v0.models.json.jsObjectNameForm(obj)
      }
    }

    implicit def jsonReadsUserPasswordChangeForm: play.api.libs.json.Reads[io.flow.user.v0.models.PasswordChangeForm] = {
      for {
    ...
    implicit def jsonWritesUserPasswordChangeForm: play.api.libs.json.Writes[PasswordChangeForm] = {
      (obj: io.flow.user.v0.models.PasswordChangeForm) => {
        io.flow.user.v0.models.json.jsObjectPasswordChangeForm(obj)
      }
    }

    implicit def jsonReadsUserPasswordResetForm: play.api.libs.json.Reads[io.flow.user.v0.models.PasswordResetForm] = {
      for {
    ...
    implicit def jsonWritesUserPasswordResetForm: play.api.libs.json.Writes[PasswordResetForm] = {
      (obj: io.flow.user.v0.models.PasswordResetForm) => {
        io.flow.user.v0.models.json.jsObjectPasswordResetForm(obj)
      }
    }

    implicit def jsonReadsUserPasswordResetRequestForm: play.api.libs.json.Reads[io.flow.user.v0.models.PasswordResetRequestForm] = {
      (__ \ "email").read[String].map { x => PasswordResetRequestForm(email = x) }
    }
    ...
    implicit def jsonWritesUserPasswordResetRequestForm: play.api.libs.json.Writes[PasswordResetRequestForm] = {
      (obj: io.flow.user.v0.models.PasswordResetRequestForm) => {
        io.flow.user.v0.models.json.jsObjectPasswordResetRequestForm(obj)
      }
    }

    implicit def jsonReadsUserUserForm: play.api.libs.json.Reads[io.flow.user.v0.models.UserForm] = {
      for {
    ...
    def jsObjectUserForm(obj: io.flow.user.v0.models.UserForm): play.api.libs.json.JsObject = {
      ...
      (obj.name match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("name" -> io.flow.user.v0.models.json.jsObjectNameForm(x))
      })
    }

    implicit def jsonWritesUserUserForm: play.api.libs.json.Writes[UserForm] = {
      (obj: io.flow.user.v0.models.UserForm) => {
        io.flow.user.v0.models.json.jsObjectUserForm(obj)
      }
    }

    implicit def jsonReadsUserUserPutForm: play.api.libs.json.Reads[io.flow.user.v0.models.UserPutForm] = {
      for {
        email <- (__ \ "email").readNullable[String]
        name <- (__ \ "name").readNullable[io.flow.user.v0.models.NameForm]
    ...
    implicit def jsonWritesUserUserPutForm: play.api.libs.json.Writes[UserPutForm] = {
      (obj: io.flow.user.v0.models.UserPutForm) => {
        io.flow.user.v0.models.json.jsObjectUserPutForm(obj)
      }
    }

    implicit def jsonReadsUserUserVersion: play.api.libs.json.Reads[io.flow.user.v0.models.UserVersion] = {
      for {
    ...
    implicit def jsonWritesUserUserVersion: play.api.libs.json.Writes[UserVersion] = {
      (obj: io.flow.user.v0.models.UserVersion) => {
        io.flow.user.v0.models.json.jsObjectUserVersion(obj)
      }
    }
  }
}
...
package io.flow.user.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder app.apibuilder.io/flow/user/latest/play_2_8_client"
    val Version = "0.19.84"
    val VersionMajor = 0
  ...
  class Client(
    ...
    private val logger = play.api.Logger("io.flow.user.v0.Client")
    ...
    object Users extends Users {
      ...
      override def getById(
        ...
        _executeRequest("GET", s"/users/${play.utils.UriEncoding.encodePathSegment(id, "UTF-8")}", requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 401 => throw io.flow.user.v0.errors.UnitResponse(r.status)
          case r if r.status == 404 => throw io.flow.user.v0.errors.UnitResponse(r.status)
          case r => throw io.flow.user.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 401, 404")
        }
      }
      ...
      override def patchPasswordsById(
        ...
        _executeRequest("PATCH", s"/users/${play.utils.UriEncoding.encodePathSegment(id, "UTF-8")}/passwords", body = Some(payload), requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 404 => throw io.flow.user.v0.errors.UnitResponse(r.status)
          case r if r.status == 422 => throw io.flow.user.v0.errors.GenericErrorResponse(r)
          case r => throw io.flow.user.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 204, 401, 404, 422")
        }
      }
