 ...
 * apidoc:0.10.0 http://localhost:9000/flow/user/0.0.5-dev/play_2_4_client
 */
  ...
  package object json {
    ...
    implicit def jsonWritesUserUserVersion: play.api.libs.json.Writes[UserVersion] = {
      (
        ...
        (__ \ "user").write[io.flow.common.v0.models.User]
...
package io.flow.user.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.10.0 http://localhost:9000/flow/user/0.0.5-dev/play_2_4_client"
