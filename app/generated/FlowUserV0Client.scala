 ...
 * apibuilder 0.14.86 app.apibuilder.io/flow/user/latest/play_2_6_client
 */
...
package io.flow.user.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.86 app.apibuilder.io/flow/user/latest/play_2_6_client"
    val Version = "0.7.94"
    val VersionMajor = 0
