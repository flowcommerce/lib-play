 ...
 * Service version: 0.8.43
 * apibuilder 0.14.93 app.apibuilder.io/flow/user/latest/play_2_8_client
 */
...
package io.flow.user.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.93 app.apibuilder.io/flow/user/latest/play_2_8_client"
    val Version = "0.8.43"
    val VersionMajor = 0
