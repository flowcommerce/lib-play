 ...
 * apibuilder 0.15.8 app.apibuilder.io/flow/user/latest/play_2_8_client
 */
...
package io.flow.user.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.15.8 app.apibuilder.io/flow/user/latest/play_2_8_client"
    val Version = "0.9.33"
    val VersionMajor = 0
