 ...
 * apibuilder 0.15.6 app.apibuilder.io/flow/user/latest/play_2_8_client
 */
...
package io.flow.user.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.15.6 app.apibuilder.io/flow/user/latest/play_2_8_client"
    val Version = "0.9.12"
    val VersionMajor = 0
