 ...
 * apibuilder:0.12.52 https://app.apibuilder.io/flow/user/0.3.65/play_2_4_client
 */
...
package io.flow.user.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.52 https://app.apibuilder.io/flow/user/0.3.65/play_2_4_client"
    val Version = "0.3.65"
    val VersionMajor = 0
    ...
    object Users extends Users {
      override def get(
        ...
        _executeRequest("GET", s"/users", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 401 => throw io.flow.user.v0.errors.UnitResponse(r.status)
          case r => throw io.flow.user.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 401")
        }
      }
...
//      import play.api.Play.current
  ...
  trait Users {
     ...
     * 
     * @param userId Filter to users with any one of these ids.
     */
    def getVersions(
      id: _root_.scala.Option[Seq[String]] = None,
      userId: _root_.scala.Option[Seq[String]] = None,
