 ...
 * Service version: 0.1.91
 * apidoc:0.11.47 http://www.apidoc.me/flow/user/0.1.91/play_2_4_client
 */
...
package io.flow.user.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.47 http://www.apidoc.me/flow/user/0.1.91/play_2_4_client"
    val Version = "0.1.91"
    val VersionMajor = 0
