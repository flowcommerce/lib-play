 ...
 * apibuilder:0.12.3 https://api.apibuilder.io/flow/user/0.2.77/play_2_4_client
 */
...
package io.flow.user.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.3 https://api.apibuilder.io/flow/user/0.2.77/play_2_4_client"
    val Version = "0.2.77"
    val VersionMajor = 0
