...
/** @param denylistFields
  *   Any value for a field with this name will be redacted
  * @param denylistModels
  *   All fields for these models will be redacted
  * @param allowlistModelFields
  *   A Map from `type name` to list of fields to white list of fields to allow in the output
  */
...
case class JsonSafeLogger(
  ...
  /** Accepts a JsValue, redacting any fields that may contain sensitive data
    ...
    *   The JsValue itself
    * @param typ
    *   The type represented by the JsValue if resolved from the API Builder specification
    */
  def safeJson(
    value: JsValue,
